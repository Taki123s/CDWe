...
class Footer extends Component {
    componentDidMount() {
        ...
        scrollToTopButton.addEventListener('click', this.scrollToTop);
    ...
    componentWillUnmount() {
        const scrollToTopButton = document.getElementById('scrollToTopButton');
        scrollToTopButton.removeEventListener('click', this.scrollToTop);
    }
                ...
                <div className="container">
                    <div className="ah_footer">
                        <div className="row">
                            ...
                            <div className="col-lg-3">
                                <p>
                                    Copyright &copy; <script>document.write(new Date().getFullYear());</script> All rights reserved | 20130012 & 20130305 & 20130115
                                </p>
                            </div>
                        </div>
                    </div>
